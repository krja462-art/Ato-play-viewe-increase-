  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
        ...
        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-sm font-medium text-zinc-500">Coin Balance</p>
            <p className="text-3xl font-extrabold text-zinc-900">{user.coins.toLocaleString()}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-sm font-medium text-zinc-500">Active Campaigns</p>
            <p className="text-3xl font-extrabold text-zinc-900">{activeCount}</p>
        ...
        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-sm font-medium text-zinc-500">Total Views Delivered</p>
            <p className="text-3xl font-extrabold text-zinc-900">{totalViewsEarned}</p>
            <p className="text-xs text-purple-600 font-medium">Real AtoPlay viewers</p>
          </div>
        ...
        <div className="bg-white rounded-2xl p-6 border border-zinc-200 shadow-sm flex items-center justify-between">
          <div className="space-y-1">
            <p className="text-sm font-medium text-zinc-500">Login Streak</p>
            <p className="text-3xl font-extrabold text-zinc-900">{user.streak} Days</p>
            <p className="text-xs text-amber-600 font-medium">Keep streak alive!</p>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        {/* Daily Check-In Card */}
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200 shadow-sm flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-lg text-zinc-900">Daily Streak Check-In</h3>
        ...
        <div className="bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200 shadow-sm flex flex-col justify-between">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-bold text-lg text-zinc-900">AdMob Rewarded Video</h3>
                  <p className="text-xs text-zinc-500">Instant +100 Bonus Coins</p>
                </div>
              </div>
          ...
          <div className="mt-6 pt-4 border-t border-zinc-100 flex items-center justify-between">
            <span className="text-xs text-zinc-500">Sponsored by Google AdMob</span>
            <button
              onClick={onWatchAd}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 bg-white rounded-3xl p-6 sm:p-8 border border-zinc-200 shadow-sm space-y-6">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="text-xl font-bold text-zinc-900">My Active Campaigns</h3>
              <p className="text-sm text-zinc-500">Real-time view progress tracking</p>
            </div>
            <button 
              onClick={() => setActiveTab('campaigns')}
              className="text-sm font-semibold text-red-600 hover:underline flex items-center space-x-1"
            >
              <span>View All</span>
          ...
          {myCampaigns.length === 0 ? (
            <div className="text-center py-12 border-2 border-dashed border-zinc-200 rounded-2xl">
              ...
              <p className="text-zinc-600 font-medium">No promotion campaigns yet</p>
            ...
            <div className="space-y-4">
              {myCampaigns.slice(0, 3).map(camp => {
                ...
                return (
                  <div key={camp.id} className="p-4 rounded-2xl bg-zinc-50 border border-zinc-100 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    <div className="flex items-center space-x-4">
                      <img src={camp.thumbnailUrl} alt={camp.title} className="w-20 h-12 object-cover rounded-lg shadow-sm" />
                      <div className="space-y-1">
                        <h4 className="font-semibold text-sm text-zinc-900 line-clamp-1">{camp.title}</h4>
                        <p className="text-xs text-zinc-500">Duration: {camp.durationSeconds}s • Cost: {camp.totalCoinsCost} coins</p>
                      </div>
                    </div>

                    <div className="w-full sm:w-48 space-y-1.5">
                      <div className="flex justify-between text-xs font-semibold">
                        <span className="text-zinc-700">{camp.completedViews} / {camp.targetViews} views</span>
